      ...
      <div>
        {isOpen &&
          <LB
            ...
            nextSrc={images[(photoIndex + 1) % images.length].src.replace("upload", "upload/t_web_large")}
            prevSrc={images[(photoIndex + images.length - 1) % images.length].src.replace("upload", "upload/t_web_large")}
